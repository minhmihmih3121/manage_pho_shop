 ...
 * @author Admins
 */
public class SuaThit extends javax.swing.JDialog {
    ...
    ResultSet rs=null;
    String sql;
    public SuaThit(java.awt.Frame parent, boolean modal,Thit a) {
        super(parent, modal);
        initComponents();
        MaThitTF.setText(a.getMaThit());
        NameTF.setText(a.getLoai());
        SLTF.setText(String.valueOf(a.getTinhtrang()));
    }
    ...
    private void initComponents() {
        ...
        MaThitTF = new javax.swing.JLabel();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(MaThitTF, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGap(20, 20, 20))
            .addGroup(layout.createSequentialGroup()
                .addGap(59, 59, 59)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(MaThitTF, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(11, 11, 11)
    ...
    private void ThemBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThemBTActionPerformed
        try {
            sql="update THIT set Loai=?, TinhTrang=? where MaTHIT='"+MaThitTF.getText()+"'";
            PreparedStatement ps=cn.prepareStatement(sql);
            ps.setString(1,NameTF.getText());
            ps.setInt(2,Integer.parseInt(SLTF.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaThit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel MaThitTF;
