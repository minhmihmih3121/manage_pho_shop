...
public class ThemBan extends javax.swing.JDialog {
    ...
    ResultSet rs=null;
    String sql;
    public ThemBan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void ThemBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThemBTActionPerformed
        try {
            ...
            ps.setString(1,SobanTF.getText());
            ps.setString(2,LoaiTF.getText());
            ps.setInt(3,Integer.parseInt(ChoTF.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemBan dialog = new ThemBan(new javax.swing.JFrame(), true);
